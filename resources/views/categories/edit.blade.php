...
<x-admin-dashboard dashTitle='Modifier Categories'>
    <form method="Post" action="{{route('categories.update',$category)}}">
        @csrf
        @method('Put')
        <div data-mdb-input-init class="form-outline">
            <input type="text" id="form1Example1" class="form-control @error('nom_categorie') is-invalid @enderror" name="nom_categorie" value="{{$category->nom_categorie}}" />
